        ...
        <div class="search-widget-inner">
            <div class="predefined-destinations-block">
                ...
                <ul id="predefined-destinations">
                            <li>
                                <input type="radio" class="radio" id="AREA-fd2bad19-0ff0-4bc0-95ff-d692ca5f5221|cities|Ring of Kerry, Ireland" name="predefined" value="Ring of Kerry, Ireland"/>
                                <label for="AREA-fd2bad19-0ff0-4bc0-95ff-d692ca5f5221|cities|Ring of Kerry, Ireland">Ring of Kerry</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-26dfff5f-5dd4-4da4-8b1a-b7fe5f2b61d5|cities|Donegal, Ireland" name="predefined" value="Donegal, Ireland"/>
                                <label for="AREA-26dfff5f-5dd4-4da4-8b1a-b7fe5f2b61d5|cities|Donegal, Ireland">Donegal</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-01abaf4b-ff8d-4e93-962d-1709d513cea9|cities|Cork, Ireland" name="predefined" value="Cork, Ireland"/>
                                <label for="AREA-01abaf4b-ff8d-4e93-962d-1709d513cea9|cities|Cork, Ireland">Cork</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-48c998e1-f678-4db4-a505-33592852defe|cities|Dublin, Ireland" name="predefined" value="Dublin, Ireland"/>
                                <label for="AREA-48c998e1-f678-4db4-a505-33592852defe|cities|Dublin, Ireland">Dublin</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-cfe5105e-eb2d-400b-ab16-d5ac4b1f8e97|cities|Galway, Fanore, Ireland (galway ireland)" name="predefined" value="Galway, Fanore, Ireland (galway ireland)"/>
                                <label for="AREA-cfe5105e-eb2d-400b-ab16-d5ac4b1f8e97|cities|Galway, Fanore, Ireland (galway ireland)">Galway</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-0719d25f-c12f-49b5-9ce5-a5971136b696|cities|Wicklow, Courtown, Ireland" name="predefined" value="Wicklow, Courtown, Ireland"/>
                                <label for="AREA-0719d25f-c12f-49b5-9ce5-a5971136b696|cities|Wicklow, Courtown, Ireland">Wicklow</label>
                            </li>
                </ul>
            </div>
...
<script src="https://www.travelnow.com/templates/490320/static/1/default/js/yui2/yuiloader/yuiloader-min.js"><!-- --></script>

<!-- Loads the calendar locale. -->
<script src="https://www.travelnow.com/templates/490320/static/1/default/js/locales/locale_en.js"><!-- --></script>
...
var SearchWidget = {
    ...
    decorateSearch : function() {
        ...
        self.YAHOO.util.Event.on(self.YAHOO.util.Dom.get(self.SEARCH_ID), "click", function() {
            ...
            var url = "https://www.travelnow.com/templates/490320/searchWidget?autosearch=true";
...
var searchWidgetYahooUIloader = new YAHOO.util.YUILoader({
    ...
    base: 'https://www.travelnow.com/templates/490320/static/1/default/js/yui2/'
